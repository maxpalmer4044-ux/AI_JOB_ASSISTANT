...
def render_settings_tab() -> None:
    ...
    st.caption("The default context is Malcolm's current AI workflow and implementation profile. Edit this when adapting the app for another user.")
    ...
    with st.form("profile_context_form"):
        ...
        with right:
            reset_context = st.form_submit_button("Reset To Malcolm Default", use_container_width=True)
    ...
    if reset_context:
        ...
        st.success("Restored Malcolm's default evaluation context.")
        st.rerun()
